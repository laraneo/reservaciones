...
class Settings extends Model
{
    protected $fillable = [
		...
		'bookingUser_startTime',
		'bookingUser_endTime',
		'bookingTimeout',
		'bookingUser_maxDays',
		'bookingUserPerDay',
		'bookingUser_minPlayers',
		'bookingUser_maxPlayers',
		'bookingUser_maxGuests',
		'bookingEmailMainPlayer',
		'bookingEmailPlayers',
		'bookingEmailAdmins',
		'bookingSMSMainPlayer',
		'bookingSMSPlayers',
		'bookingSMS_clientid',
        ...
        'bookingUserPlayPerWeek',
        'bookingUserPlayPerMonth',
