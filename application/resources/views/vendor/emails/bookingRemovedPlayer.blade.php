...
| $twitter_link | $google_plus_link | $instagram_link | $pinterest_link | $locator 
| $player_type | $player_doc_id | $player_email | $player_phone | $player_first_name | $player_last_name | $player_token
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																...
																Ha sido <font color='#ff0000'><b>REMOVIDO</b> </font> por 
																{{ $customer_first_name }} {{ $customer_last_name }} 
																<br>de la partida con localizador 
																<font color='#0000ff'>
																<b>
																{{ $localizador }}
																</b>
																...
																<!---
																<a class="mcnButton" title="Confirmar Participacion" href="{{ route('login') }}/custom/confirmPlayer.php?token={{ $player_token }}" 
																target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">{{ __('emails.confirm') }}</a>													
																</a>
																...
																<table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #007BFF;">
																	...
																	<tr>
																		<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; padding: 18px;">
																			<a class="mcnButton " title="{{ __('emails.confirm_btn') }}" href="{{ route('index') }}/custom/confirmPlayer.php?token={{ $player_token }}"  target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">{{ __('emails.confirm_btn') }}</a>
																		</td>
																	</tr>
																	</tbody>
																</table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																...
																<b>NOTAS:</b><br>
 <!--
 En caracter de invitado puede ingresar un maximo de {{ config('settings.bookingUser_maxGuests', '2') }} veces al mes al club.<br>
 Como Socio, debe estar solvente con su cuota de mantenimiento previo a iniciar la partida.<br>
-->
