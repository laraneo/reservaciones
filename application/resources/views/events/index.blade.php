...
<script>
    ...
    function onSelecType() {
        ...
        if (id == -1) {
            window.location.href = `${url}/events?type=&category=${category}&internal=${internal}`;
        } else {
            window.location.href = `${url}/events?type=${id}&category=${category}&internal=${internal}`;
        }
    }
    ...
    function onSelecCategory() {
        ...
        const internal = document.getElementById("internal").value;
        if (id > 0) {
            window.location.href = `${url}/events?type=${type}&category=${id}&internal=${internal}`;
        } else {
            window.location.href = `${url}/events?type=${type}&category=&internal=${internal}`;
        }
    }
    ...
    function onSelecInternal() {
        ...
        if (id == -1) {
            window.location.href = `${url}/events?type=${type}&category=${category}&internal=`;
        } else {
            window.location.href = `${url}/events?type=${type}&category=${category}&internal=${id}`
        }
    }
</script>
