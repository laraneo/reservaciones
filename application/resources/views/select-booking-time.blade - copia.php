...
@section('content')
    ...
    <form method="post" id="booking_step_booking_time" action="{{ route('postStepBookingTime') }}">
        {{ csrf_field() }}
        <div class="container">
            <div class="content">
...
@section('scripts')
    ...
    <script>
		...
		maxDate.setDate(today.getDate()+  {{ config('settings.bookingUser_maxDays') }} );  //LA set maximum booking days on future
