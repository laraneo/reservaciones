...
<script>
    ...
    function handleCategory() {
        ...
        if (id > 0) {
            window.location.href = `${url}/packages-types?category=${id}`;
        } else {
            window.location.href = `${url}/packages-types`;
        }
    }
    ...
    function handlePackage() {
        ...
        if (id > 0) {
            window.location.href = `${url}/packages-types?category=${category}&package=${id}`;
        } else {
            window.location.href = `${url}/packages-types?category=${category}`;
        }
    }
</script>
