...
<script>
    ...
    function onSelecCategory() {
        ...
        if (id == -1) {
            window.location.href = `${url}/customer/bookings?category=&package=`;
        } else {
            window.location.href = `${url}/customer/bookings?category=${id}&package=`;
        }
    }
    ...
    function onSelecPackage() {
        ...
        if (id == -1) {
            window.location.href = `${url}/customer/bookings?category=${category}&package=`;
        } else {
            window.location.href = `${url}/customer/bookings?category=${category}&package=${id}`;
        }
    }
    ...
    function onSelectDate() {
        ...
        if (dateStart !== '') {
            window.location.href = `${url}/customer/bookings?category=${category}&package=${package}&dateStart=${dateStart}`;
        }
