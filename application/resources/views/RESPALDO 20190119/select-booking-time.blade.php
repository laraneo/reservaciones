        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" name="event_date" id="event_date" placeholder="{{ __('app.date_placeholder') }}" autocomplete="off">
...
<script>
    ...
    maxDate.setDate(today.getDate() + {
        {
            config('settings.bookingUser_maxDays')
        }
