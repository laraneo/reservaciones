    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 text-center">
					...
					// 1 evento
					// -1 disponible
					function CalcularSlot($booking_date, $booking_time, $package_id, $conn)
					{
						$status = -1;
					...
					$sql = "select id, title from packages where category_id=2";
					...
					{	
						while($row = mysqli_fetch_assoc($result9)) 
						{
							...
							echo  "<br><strong>" . $package_name . "</strong> <br>";
							echo  $event_date . " @ ";
							...
							while ($hour <	$end_time)
							{
								...
								$status = CalcularSlot($booking_date, $booking_time, $package_id, $conn);
